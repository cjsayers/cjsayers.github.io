...
The electronic structure of materials dictates many of their chemical, electrical and optical properties. In order to directly visualise this structure, I use angle-resolved photoemission spectroscopy (ARPES). This technique relies on Einstein's theory of the photoelectric effect, whereby electrons are emitted from a sample surface when irradiated with light of sufficient energy. By measuring both the kinetic energy and angle of the emitted electrons, we can reconstruct the internal electronic structure.
